...
var useComponent = function useComponent(key) {
  var _options$data, _req$headers, _queryData$renderComp5, _queryData$renderComp6, _options$data4, _queryData$renderComp10, _queryData$renderComp11, _lastMutationResult$e;
  ...
  if (typeof window === 'undefined' && (!options.ssr || !options.suspend)) {
    console.log('SSR without suspend flag. Make sure you pass a suspend option', key, new Error().stack);
  }
  if (options.suspend) {
    try {
