...
var useServerState = function useServerState(clientDefaultValue, options) {
  ...
  try {
    ...
    React.useEffect(function () {}, [_id, error, key]);
    ...
    try {
      ...
      var _temp5 = function () {
        if (challenge.type === 'register') {
          return Promise.resolve(client.solveRegistrationChallenge(challenge.challenge)).then(function (_solveRegistrationCha) {
