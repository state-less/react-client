...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `state-less`, `react-client`, `@statelesscloud`, `Moritz Roessler`, `GMail`, `moritz.roessler@gmail.com`, `React Client`, `The react-server client library.`
...
2. Clone the repo
   ```sh
   git clone https://github.com/state-less/react-client.git
   ```
